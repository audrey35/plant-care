...
app.post("/post",isLoggedIn ,(req,res) =>{
  ...
  var new_post = new Post({name: name, title: req.body.title, text: req.body.content, username: req.user.username});
...
app.post("/post/:postname/comment",isLoggedIn ,(req,res) =>{
  ...
  Post.findOneAndUpdate({name: req.params.postname}, 
...
app.post("/register",(req,res)=>{
  var private = {username: req.body.username,phone:req.body.phone,telephone: req.body.telephone};
